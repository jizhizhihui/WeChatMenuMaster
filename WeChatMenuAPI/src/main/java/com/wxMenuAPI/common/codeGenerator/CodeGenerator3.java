package com.wxMenuAPI.common.codeGenerator;
...
public class CodeGenerator3 {
    ...
    private static String url = "jdbc:mysql://10.12.9.102:3306/wx_ment?serverTimezone=CTT";
...
//        focList.add(new FileOutConfig("/templates/cg/mapper.mapper.ftl") {
//            @Override
//            public String outputFile(TableInfo tableInfo) {
//                // 自定义输入文件名称
//                return projectPath + "/springboot-mybatis-plus/src/main/resources/mybatis/mapper/"
...
//                .setDbColumnUnderline(true)   // 全局下划线命名
                ...
                .setInclude("t_comment_start"); // 需要生成的表,默认全部
...
//                .setSuperServiceClass("com.baomidou.test.base.BsBaseService") // 自定义 api 父类
//                .setSuperServiceImplClass("com.baomidou.test.base.BsBaseServiceImpl") // 自定义 api 实现类父类
